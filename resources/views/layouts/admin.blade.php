...
<body>
    <div id="app">
        <header class="py-2 bg-primary">
            <div class="container">
                <div class="d-flex align-items-center">
                    ...
                    <div class="justify-items-end px-3">
                        <a class="btn btn-info" href="{{url('/admin/')}}">Go Home</a>
                    </div>
                    <div class="justify-items-end px-3">
                        <a class="btn btn-secondary" href="/landing">Change image</a>
                    </div>
                </div>
        ...
        <div class="d-flex flex-column flex-md-row text-center text-md-start justify-content-between py-4 px-4 px-xl-5 bg-primary footer">
            ...
            Copyright © 2022 Maxedge. All rights reserved.
            </div>
            <!-- Copyright -->
