...
<script>
    export default {
        ...
        methods: {
            ...
            async getCategories(){
                let response = await axios.get(this.appURL+"/get-categories")
                this.categories = response.data
            },
            async getCategoriesByTitle(title){
                let response = await axios.get(this.appURL+`/get-categories-bytitle/${title}`)
                return response.data
            },
            async questionGroup(){
                let response = await axios.get(this.appURL+"/get-question-group")
            ...
            async addQuestionGroup(){
                ...
                let response = await axios.post(this.appURL+"/add-question-group", data)
            ...
            async updateQuestion(){
                ...
                await axios.post(this.appURL+`/admin/questions/update/${this.thisquestion.id}`, data)
                .then((response)=>{
                    this.isError = false
                    window.scrollTo(top)
            ...
            async getQuestion(){
                let response = await axios.get(this.appURL+`/get-question-byid/${this.thisquestion.id}`)
