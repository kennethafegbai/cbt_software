...
Route::get('/', function () {
    ...
    return view('main.home', ['landing'=>$landing]);
});
...
Route::get('/landing', [App\Http\Controllers\LandingController::class, 'landing']);
Route::patch('/landing', [App\Http\Controllers\LandingController::class, 'update']);
